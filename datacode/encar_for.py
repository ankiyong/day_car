...
def get_page(i,option):
    c = color(option)
    url = f'http://api.encar.com/search/car/list/premium?count=true&q=(And.Hidden.N._.CarType.N._.Trust.Warranty._.({c}))&sr=%7CModifiedDate%7C{i*50}%7C50'
...
def to_df_for(option):
    info = add_info_for(option)
